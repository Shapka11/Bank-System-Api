...
public static class HistoryOperationMappingExtensions
{
    ...
    public static InvoiceApprovedHistoryOperationModel MapToModel(this InvoiceApprovedHistoryOperationDto dto)
        => new(
            dto.Id,
            dto.AccountId,
            dto.InvoiceId,
    ...
    public static InvoiceDeclinedHistoryOperationModel MapToModel(this InvoiceDeclinedHistoryOperationDto dto)
        => new(
            dto.Id,
            dto.AccountId,
            dto.InvoiceId,
