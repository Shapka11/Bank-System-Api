...
public static class InvoiceStatusMappingExtensions
{
    public static BankInvoiceStatusModel MapToModel(this ProtoInvoiceStatus protoStatus)
    {
        return protoStatus switch
        {
            ...
            ProtoInvoiceStatus.Approved => BankInvoiceStatusModel.Approved,
            ProtoInvoiceStatus.Declined => BankInvoiceStatusModel.Declined,
    ...
    public static ProtoInvoiceStatus MapToProto(this BankInvoiceStatusModel model)
    {
        return model switch
        {
            ...
            BankInvoiceStatusModel.Approved => ProtoInvoiceStatus.Approved,
            BankInvoiceStatusModel.Declined => ProtoInvoiceStatus.Declined,
