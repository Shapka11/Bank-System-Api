...
public static class HistoryOperationMappingExtensions
{
    public static HistoryOperationDto MapToDto(this HistoryOperation operation)
    {
        return operation switch
        {
            ...
            InvoiceApprovedHistoryOperation op => op.MapToDto(),
            InvoiceDeclinedHistoryOperation op => op.MapToDto(),
    ...
    public static InvoiceApprovedHistoryOperationDto MapToDto(this InvoiceApprovedHistoryOperation operation)
        => new(
            operation.Id.Value,
            operation.AccountId.Value,
            operation.InvoiceId.Value,
    ...
    public static InvoiceDeclinedHistoryOperationDto MapToDto(this InvoiceDeclinedHistoryOperation operation)
        => new(
            operation.Id.Value,
            operation.AccountId.Value,
            operation.InvoiceId.Value,
