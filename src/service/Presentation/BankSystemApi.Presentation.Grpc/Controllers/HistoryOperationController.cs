...
public sealed class HistoryOperationController : HistoryOperationService.HistoryOperationServiceBase
{
    ...
    public override async Task<ProtoGetHistoryOperationsResponse> Get(
        ProtoGetHistoryOperationsRequest request,
        ServerCallContext context)
    {
        ...
        {
            GetHistoryOperations.Response.Success success => new ProtoGetHistoryOperationsResponse(
