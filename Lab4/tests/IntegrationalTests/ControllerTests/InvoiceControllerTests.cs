...
public sealed class InvoiceControllerTests : IAsyncDisposable
{
    ...
    public async Task CreateInvoiceAsync_ShouldCreateInvoice()
    {
        ...
        var request = new ProtoCreateInvoiceRequest(
            ...
            senderAccount.Id.Value.ToString(),
            receiverAccount.Id.Value.ToString(),
        ...
        response.Invoice.SenderAccountId.Should().Be(senderAccount.Id.Value.ToString());
        response.Invoice.ReceiverAccountId.Should().Be(receiverAccount.Id.Value.ToString());
