...
public sealed class InvoiceClient : IInvoiceClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        ProtoCreateInvoiceResponse clientResponse = await _invoiceClient.CreateAsync(
            clientRequest,
            cancellationToken: cancellationToken);
    ...
    public async Task<PayInvoice.Response> PayAsync(PayInvoice.Request request, CancellationToken cancellationToken)
    {
        ...
        ProtoPayInvoiceResponse clientResponse = await _invoiceClient.PayAsync(
            clientRequest,
            cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        ProtoRevokeInvoiceResponse clientResponse = await _invoiceClient.RevokeAsync(
            clientRequest,
            cancellationToken: cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        ProtoGetInvoicesResponse clientResponse = await _invoiceClient.GetAsync(
            clientRequest,
            cancellationToken: cancellationToken);
